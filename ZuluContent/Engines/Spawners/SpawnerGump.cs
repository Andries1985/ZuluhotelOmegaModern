    ...
    public class SpawnerGump : Gump
    {
        ...
        public SpawnerGump(BaseSpawner spawner, SpawnerEntry focusentry = null, int page = 0) : base(50, 50)
        {
            ...
            for (var i = 0; i < 13; i++)
            {
                ...
                AddTextEntry(75, 22 * i + 21 + offset, 156, 21, (flags & EntryFlags.InvalidType) != 0 ? 33 : 0,
                    textindex,
                    name); // creature
                ...
                if (entry != null && m_Entry == entry)
                {
                    ...
                    AddTextEntry(59, 22 * i + 42, 248, 21, (flags & EntryFlags.InvalidParams) != 0 ? 33 : 0,
                        textindex + 3,
                        entry.Parameters); // parameters
                    AddTextEntry(59, 22 * i + 62, 248, 21, (flags & EntryFlags.InvalidProps) != 0 ? 33 : 0,
                        textindex + 4,
