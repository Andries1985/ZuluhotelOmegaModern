...
public class MeleeBT<T> : BaseSingleton<MeleeBT<T>>, IBTTree<T> where T : IAIState
{
    ...
    public static BTNode<T> DoCombat()
    {
        return new BTSequence<T>(new List<BTNode<T>>
        {
            ...
            new DoEndCombat<T>(),
            new BTInverter<T>(new BTSequence<T>(new List<BTNode<T>>
            {
                new CheckShouldFlee<T>(),
                new DoBeginFleeing<T>()
            })),
            new BTSelector<T>(new List<BTNode<T>>
            {
                new CheckCombatantExists<T>(),
    ...
    public static BTNode<T> DoEndCombatTimer()
    {
        return new BTInverter<T>(new BTSucceeder<T>(new DoEndCombatTimer<T>()));
    }
    
    public static BTNode<T> DoFlee()
    {
        return new BTSequence<T>(new List<BTNode<T>>
        {
            new BTSelector<T>(new List<BTNode<T>>
            {
                new CheckFleeing<T>(),
                new BTInverter<T>(new BTSucceeder<T>(new DoEndFleeing<T>()))
            }),
            new CheckCombatantExists<T>(),
            new DoMoveToTarget<T>(MoveToTargetType.Combatant, true, true),
            new DoProcessFleeing<T>(),
            new BTInverter<T>(new BTSucceeder<T>(new DoEndFleeing<T>()))
        });
    }
